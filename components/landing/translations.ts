...
export const translations = {
  es: {
    ...
    hero: {
      badge: "¿Sigues coordinando reservas por mensajes?",
      title: "Mensajes sin fin. Reservas duplicadas. Tu flujo debería evitar ambos.",
      body: "Cuando la disponibilidad vive en mensajes, aparecen respuestas, capturas y cambios manuales. Dos personas pueden intentar tomar el mismo horario y cada cambio vuelve a tu bandeja de entrada.",
      solutionEyebrow: "La solución de un solo enlace",
      solutionTitle: "Comparte tu página. Haab protege la selección y deja que el cliente termine por su cuenta.",
      solutionSteps: [
        "Ven disponibilidad real",
        "Reciben un apartado de 10 min",
        "Reagendan o cancelan solos",
      ],
      ...
      previewBadge: "Página pública activa",
      previewEyebrow: "Ejemplo de salud",
      previewTitle: "Dra. Maya Rivera",
      previewSubtitle: "Medicina familiar · Nueva York",
      previewService: "Consulta para pacientes nuevos",
      previewServiceMeta: "30 min · $95 · 1 paciente",
      previewAvailability: "Disponibilidad real",
      previewProofs: [
        "Reserva sin crear cuenta",
        "Apartado visible de 10 minutos",
        "Enlace privado para gestionar",
      ],
      previewCta: "Abrir la página y probarla →",
    },
    liveExamples: {
  ...
  en: {
    ...
    hero: {
      badge: "Still coordinating bookings through messages?",
      title: "Endless messages. Double bookings. Your booking flow should prevent both.",
      body: "When availability lives in messages, you get replies, screenshots, and manual changes. Two people can reach for the same time, and every change comes back to your inbox.",
      solutionEyebrow: "The one-link solution",
      solutionTitle: "Share your page. Haab protects the selection and lets the client finish on their own.",
      solutionSteps: [
        "They see live availability",
        "They get a 10-minute hold",
        "They reschedule or cancel",
      ],
      ctaPrimary: "Try a real booking →",
      ctaSecondary: "Create my page",
      fineprint: "No client account · Appointments, full days, and capacity-based registration.",
      previewBadge: "Live public page",
      previewEyebrow: "Healthcare example",
      previewTitle: "Dr. Maya Rivera",
      previewSubtitle: "Family medicine · New York",
      previewService: "New patient consultation",
      previewServiceMeta: "30 min · $95 · 1 patient",
      previewAvailability: "Live availability",
      previewProofs: [
        "Book without an account",
        "Visible 10-minute hold",
        "Private management link",
      ],
      previewCta: "Open the page and try it →",
    },
    liveExamples: {
