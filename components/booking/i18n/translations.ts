...
export const bookingTranslations: Record<Lang, BookingDict> = {
  ...
  es: {
    ...
    manage: {
      ...
      contactProvider: "Contactar al administrador",
      ...
      noteTitle: "Nota para el administrador",
      ...
      noteSaved: "Nota enviada al administrador.",
    ...
    publicFlow: {
      ...
      providerLogoAlt: "Logotipo del administrador",
      ...
      scanToAdd: "Escanee para abrir los detalles o presente este código al administrador",
    ...
    admin: {
      ...
      providerInformation: "Información del administrador",
    ...
    setup: {
      ...
      providerRequiredFieldsError: "El nombre del administrador, el nombre del negocio y el correo electrónico son obligatorios.",
    },
    healthcareRole: {
